...
import { IconEdit, IconTrash, IconX,IconCheck } from "@tabler/icons";
  ...
  return (
    <Container>
      <Group position="apart" className={classes.header}>
        ...
        <Button
          onClick={() => {
            navigate("/admin/manage-products/new");
          }}
        >
          Add New Product
        </Button>
                  ...
                  <Grid px={5}>
                    <Grid.Col>
                      ...
                      <Text
                        ...
                        transform="uppercase"
                      >
                      {i.product.price.low ? i.product.price.low : i.product.price} {"DA"}
                      </Text>
                    </Grid.Col>
                  </Grid>
                  <Grid px={5}>
